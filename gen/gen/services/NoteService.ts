...
import type { NoteUpdateForEntityArgs } from '../models/NoteUpdateForEntityArgs';
...
export class NoteService {
    ...
    /**
     * Update Note For Entity
     * Update a note.
     * @param requestBody
     * @returns any Successful Response
     * @throws ApiError
     */
    public updateNoteForEntity(
        requestBody: NoteUpdateForEntityArgs,
    ): CancelablePromise<any> {
        return this.httpRequest.request({
            method: 'POST',
            url: '/note/update-for-entity',
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                406: `Feature Not Available`,

...
) -> Optional[Union[Any, MetricCreateResult]]:
    if response.status_code == 200:
        response_200 = MetricCreateResult.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, MetricCreateResult]]:
    return Response(

...
T = TypeVar("T", bound="PersonUpdateArgsCatchUpEisen")


@_attrs_define
class PersonUpdateArgsCatchUpEisen:
    """
    Attributes:
        should_change (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        person_update_args_catch_up_eisen = cls(
            should_change=should_change,
            value=value,
        )

        person_update_args_catch_up_eisen.additional_properties = d
        return person_update_args_catch_up_eisen

...
T = TypeVar("T", bound="TimePlanAssociateInboxTaskWithPlanResult")


@_attrs_define
class TimePlanAssociateInboxTaskWithPlanResult:
    """Result.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        time_plan_associate_inbox_task_with_plan_result = cls(
            new_time_plan_activities=new_time_plan_activities,
        )

        time_plan_associate_inbox_task_with_plan_result.additional_properties = d
        return time_plan_associate_inbox_task_with_plan_result

...
T = TypeVar("T", bound="TimePlanAssociateBigPlanWithPlanArgs")


@_attrs_define
class TimePlanAssociateBigPlanWithPlanArgs:
    """Args.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        time_plan_associate_big_plan_with_plan_args = cls(
            big_plan_ref_id=big_plan_ref_id,
            time_plan_ref_ids=time_plan_ref_ids,
            kind=kind,
            feasability=feasability,
        ...
        time_plan_associate_big_plan_with_plan_args.additional_properties = d
        return time_plan_associate_big_plan_with_plan_args

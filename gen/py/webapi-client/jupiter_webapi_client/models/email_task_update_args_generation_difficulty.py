...
T = TypeVar("T", bound="EmailTaskUpdateArgsGenerationDifficulty")


@_attrs_define
class EmailTaskUpdateArgsGenerationDifficulty:
    """
    Attributes:
        should_change (bool):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        email_task_update_args_generation_difficulty = cls(
            should_change=should_change,
            value=value,
        )

        email_task_update_args_generation_difficulty.additional_properties = d
        return email_task_update_args_generation_difficulty

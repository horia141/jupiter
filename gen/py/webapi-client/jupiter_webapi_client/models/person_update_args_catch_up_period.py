...
T = TypeVar("T", bound="PersonUpdateArgsCatchUpPeriod")


@_attrs_define
class PersonUpdateArgsCatchUpPeriod:
    """
    Attributes:
        should_change (bool):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        person_update_args_catch_up_period.additional_properties = d
        return person_update_args_catch_up_period

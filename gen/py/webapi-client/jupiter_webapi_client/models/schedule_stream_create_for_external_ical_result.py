...
T = TypeVar("T", bound="ScheduleStreamCreateForExternalIcalResult")


@_attrs_define
class ScheduleStreamCreateForExternalIcalResult:
    """Result.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        schedule_stream_create_for_external_ical_result = cls(
            new_schedule_stream=new_schedule_stream,
        )

        schedule_stream_create_for_external_ical_result.additional_properties = d
        return schedule_stream_create_for_external_ical_result

...
T = TypeVar("T", bound="HabitUpdateArgsPeriod")


@_attrs_define
class HabitUpdateArgsPeriod:
    """
    Attributes:
        should_change (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        habit_update_args_period = cls(
            should_change=should_change,
            value=value,
        )

        habit_update_args_period.additional_properties = d
        return habit_update_args_period

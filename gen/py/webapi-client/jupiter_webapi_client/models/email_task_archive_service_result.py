...
T = TypeVar("T", bound="EmailTaskArchiveServiceResult")
...
class EmailTaskArchiveServiceResult:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        email_task_archive_service_result = cls(
            archived_inbox_tasks=archived_inbox_tasks,
        )

        email_task_archive_service_result.additional_properties = d
        return email_task_archive_service_result

...
T = TypeVar("T", bound="MetricUpdateArgsCollectionDifficulty")


@_attrs_define
class MetricUpdateArgsCollectionDifficulty:
    """
    Attributes:
        should_change (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        metric_update_args_collection_difficulty = cls(
            should_change=should_change,
            value=value,
        )

        metric_update_args_collection_difficulty.additional_properties = d
        return metric_update_args_collection_difficulty

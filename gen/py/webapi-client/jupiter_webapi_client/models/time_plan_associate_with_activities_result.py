...
T = TypeVar("T", bound="TimePlanAssociateWithActivitiesResult")


@_attrs_define
class TimePlanAssociateWithActivitiesResult:
    """Result.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        time_plan_associate_with_activities_result = cls(
            new_time_plan_activities=new_time_plan_activities,
        )

        time_plan_associate_with_activities_result.additional_properties = d
        return time_plan_associate_with_activities_result

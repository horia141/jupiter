...
T = TypeVar("T", bound="TimePlanActivityCreateForBigPlanArgs")


@_attrs_define
class TimePlanActivityCreateForBigPlanArgs:
    """Args.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        time_plan_activity_create_for_big_plan_args = cls(
            time_plan_ref_id=time_plan_ref_id,
            big_plan_ref_id=big_plan_ref_id,
            kind=kind,
            feasability=feasability,
        ...
        time_plan_activity_create_for_big_plan_args.additional_properties = d
        return time_plan_activity_create_for_big_plan_args

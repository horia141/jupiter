...
T = TypeVar("T", bound="SlackTaskArchiveServiceResult")
...
class SlackTaskArchiveServiceResult:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        slack_task_archive_service_result = cls(
            archived_inbox_tasks=archived_inbox_tasks,
        )

        slack_task_archive_service_result.additional_properties = d
        return slack_task_archive_service_result

...
T = TypeVar("T", bound="EmailTaskUpdateArgsGenerationEisen")


@_attrs_define
class EmailTaskUpdateArgsGenerationEisen:
    """
    Attributes:
        should_change (bool):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        email_task_update_args_generation_eisen = cls(
            should_change=should_change,
            value=value,
        )

        email_task_update_args_generation_eisen.additional_properties = d
        return email_task_update_args_generation_eisen

...
T = TypeVar("T", bound="JournalUpdateSettingsArgsPeriods")


@_attrs_define
class JournalUpdateSettingsArgsPeriods:
    """
    Attributes:
        should_change (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        journal_update_settings_args_periods = cls(
            should_change=should_change,
            value=value,
        )

        journal_update_settings_args_periods.additional_properties = d
        return journal_update_settings_args_periods

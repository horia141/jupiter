...
T = TypeVar("T", bound="WorkingMemFindArgs")


@_attrs_define
class WorkingMemFindArgs:
    """PersonFindArgs.
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        include_cleanup_tasks = self.include_cleanup_tasks
        ...
        field_dict.update(
            {
                ...
                "include_cleanup_tasks": include_cleanup_tasks,
            }
        )
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        include_cleanup_tasks = d.pop("include_cleanup_tasks")
        ...
        working_mem_find_args.additional_properties = d
        return working_mem_find_args

...
T = TypeVar("T", bound="EmailTaskLoadResult")


@_attrs_define
class EmailTaskLoadResult:
    """EmailTaskLoadResult.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        email_task_load_result = cls(
            email_task=email_task,
            inbox_task=inbox_task,
        )

        email_task_load_result.additional_properties = d
        return email_task_load_result

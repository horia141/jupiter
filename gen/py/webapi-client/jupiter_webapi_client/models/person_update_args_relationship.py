...
T = TypeVar("T", bound="PersonUpdateArgsRelationship")


@_attrs_define
class PersonUpdateArgsRelationship:
    """
    Attributes:
        should_change (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_value, Unset):
            ...
            value = PersonRelationship(_value)

        person_update_args_relationship = cls(
            should_change=should_change,
            value=value,
        )

        person_update_args_relationship.additional_properties = d
        return person_update_args_relationship

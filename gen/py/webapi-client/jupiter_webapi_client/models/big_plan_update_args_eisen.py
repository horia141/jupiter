...
T = TypeVar("T", bound="BigPlanUpdateArgsEisen")


@_attrs_define
class BigPlanUpdateArgsEisen:
    """
    Attributes:
        should_change (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        big_plan_update_args_eisen = cls(
            should_change=should_change,
            value=value,
        )

        big_plan_update_args_eisen.additional_properties = d
        return big_plan_update_args_eisen

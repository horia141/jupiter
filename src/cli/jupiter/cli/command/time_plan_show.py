...
from jupiter.core.use_cases.time_plans.find import TimePlanFindResult, TimePlanFindUseCase
from rich.console import Console
from rich.text import Text
from rich.tree import Tree

from jupiter.cli.command.rendering import entity_id_to_rich_text, entity_name_to_rich_text, period_to_rich_text, time_plan_source_to_rich_text
...
class TimePlanShow(LoggedInReadonlyCommand[TimePlanFindUseCase, TimePlanFindResult]):
    ...
    def _render_result(
        ...
        for time_plan_entry in sorted_time_plans:
            ...
            rich_tree.add(time_plan_text, guide_style="gray62" if time_plan.archived else "blue")

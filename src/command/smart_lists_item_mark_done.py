"""Command for marking a smart list item as done."""
...
class SmartListsItemMarkDone(command.Command):
    """Command for marking a smart list item as done."""
    ...
    def name() -> str:
        ...
        return "smart-lists-item-mark-done"

    @staticmethod
    def description() -> str:
        """The description of the command."""
        return "Mark a smart list item as done"
    ...
    def run(self, args: Namespace) -> None:
        ...
        self._smart_list_controller.set_smart_list_item_is_done(ref_id, True)

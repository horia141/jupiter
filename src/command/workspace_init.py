...
class WorkspaceInit(command.Command):
    ...
    def build_parser(self, parser: ArgumentParser) -> None:
        ...
        parser.add_argument("--project-key", dest="first_project_key", required=True, help="The key of the first project")
        parser.add_argument("--project-name", dest="first_project_name", required=True, help="The name of the first project")

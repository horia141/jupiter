"""Command for setting the collection time of a metric entry."""
...
class MetricsEntrySetCollectionTime(command.Command):
    """Command for setting the collection time of a metric entry."""
    ...
    def name() -> str:
        ...
        return "metrics-entry-set-collection-time"

    @staticmethod
    def description() -> str:
        """The description of the command."""
        return "Change the collection time of a metric entry"
    ...
    def run(self, args: Namespace) -> None:
        ...
        self._metrics_controller.set_metric_entry_collection_time(ref_id, collection_time)

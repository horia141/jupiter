...
class InboxTasksController:
    ...
    def create_inbox_task(
            ...
            difficulty: Optional[Difficulty], active_date: Optional[ADate], due_date: Optional[ADate]) -> InboxTask:
        ...
        return self._inbox_tasks_service.create_inbox_task(
            project.ref_id, name, big_plan_ref_id, big_plan_name, eisen, difficulty, active_date, due_date)
    ...
    def set_inbox_task_active_date(self, ref_id: EntityId, active_date: Optional[ADate]) -> InboxTask:
        ...
        return self._inbox_tasks_service.set_inbox_task_active_date(ref_id, active_date)

import { ApiError, NoteDomain, ScheduleStreamSummary } from "@jupiter/webapi-client";
import { Button, ButtonGroup, Card, CardActions, FormControl, InputLabel, OutlinedInput, Stack } from "@mui/material";
...
import { ActionMultipleSpread, ActionSingle, SectionActions } from "~/components/infra/section-actions";
...
export async function loader({ request, params }: LoaderArgs) {
  ...
  try {
    ...
    return json({
        allScheduleStreams: summaryResponse.schedule_streams as Array<ScheduleStreamSummary>,
...
export default function ScheduleEventInDayViewOne() {
  ...
  const inputsEnabled =
    ...
    const [durationMins, setDurationMins] = useState(loaderData.timeEventInDayBlock.duration_mins);
    useEffect(() => {
            ...
            <Stack spacing={2} useFlexGap>
              <FormControl fullWidth>
                ...
                <ScheduleStreamSelect
                  ...
                  defaultValue={allScheduleStreamsByRefId.get(loaderData.scheduleEventInDay.schedule_stream_ref_id)!}
                />
                <FieldError
              ...
              <FormControl fullWidth>
                ...
                <OutlinedInput label="name" name="name" readOnly={!inputsEnabled} defaultValue={loaderData.scheduleEventInDay.name} />

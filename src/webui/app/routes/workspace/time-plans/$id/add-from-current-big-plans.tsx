    ...
    switch (form.intent) {
      case "add": {
        await getLoggedInApiClient(
          ...
          ref_id: id,
          big_plan_ref_id: form.targetBigPlanRefIds,
        });
...
export default function TimePlanAddFromCurrentBigPlans() {
  ...
  const [targetBigPlansRefIds, setTargetBigPlansRefIds] = useState<Set<string>>(
    new Set(
  ...
  return (
    ...
    >
      <Card sx={{ marginBottom: "1rem" }}>
        ...
        <input
          name="targetBigPlansRefIds"
          type="hidden"
          value={new Array(targetBigPlansRefIds).join(",")}
        />

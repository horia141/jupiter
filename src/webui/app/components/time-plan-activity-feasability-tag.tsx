...
export function TimePlanActivityFeasabilityTag(props: TimePlanActivityFeasabilityTagProps) {
    return (
        <SlimChip
...
function feasabilityToColor(props: TimePlanActivityFeasability): "success" | "warning" | "info" {
    switch (props) {

...
class PersonBirthday(Value):
    ...
    _MONTH_NAME_TO_IDX: ClassVar[Dict[str, int]] = {
        'Jan': 1,
        'Feb': 2,
        'Mar': 3,
        'Apr': 4,
    ...
    _MONTH_IDX_TO_NAME: ClassVar[Dict[int, str]] = {i: n for (n, i) in _MONTH_NAME_TO_IDX.items()}
    ...
    def from_raw(birthday_str: Optional[str]) -> PersonBirthday:
        ...
        try:
            ...
            month = PersonBirthday._MONTH_NAME_TO_IDX[parts[1].capitalize()]
    ...
    def __str__(self) -> str:
        ...
        return f'{self.day} {self._MONTH_IDX_TO_NAME[self.month]}'

...
from models.basic import ProjectKey, EntityId, RecurringTaskPeriod, Timestamp
    ...
    def execute(self, args: Args) -> None:
        ...
        with self._engine.get_unit_of_work() as uow:
            ...
            if args.catch_up_project_key.should_change:
                ...
                prm_database.change_catch_up_project_ref_id(catch_up_project_ref_id, self._time_provider.get_current_time())
            else:
            ...
            for person in persons:
                if person.catch_up_params is None:
                    continue
                person.change_catch_up_params(person.catch_up_params.with_new_project_ref_id(catch_up_project_ref_id), self._time_provider.get_current_time())
                uow.person_repository.save(person)

        if old_catch_up_project_ref_id != catch_up_project_ref_id:
            ...
            for inbox_task in self._inbox_tasks_service.load_all_inbox_tasks(
                ...
                self._inbox_tasks_service.create_inbox_task_for_person(
                    ...
                    recurring_task_period=cast(RecurringTaskGenParams, person.catch_up_params).period,

...
from remote.notion.collection import BasicRowType, NotionCollection
...
class VacationsCollection:
    ...
    def copy_row_to_notion_row(
            _client: NotionClient, vacation_row: VacationRow,
            vacation_notion_row: CollectionRowBlock) -> CollectionRowBlock:
        """Copy the fields of the local row to the actual Notion structure."""
        vacation_notion_row.title = vacation_row.name
        vacation_notion_row.archived = vacation_row.archived
        vacation_notion_row.start_date = vacation_row.start_date
        vacation_notion_row.end_date = vacation_row.end_date
        vacation_notion_row.ref_id = vacation_row.ref_id

        return vacation_notion_row

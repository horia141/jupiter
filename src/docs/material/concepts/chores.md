...
Chores can be marked as _key chores_. This is first a user-level concept - it marks
the chore as an important one for you, that is absolutely necessary to get right. In

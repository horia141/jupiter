...
@use_case_args
class HomeSmallScreenTabRemoveArgs(UseCaseArgsBase):
...
class HomeSmallScreenTabRemoveUseCase(
    AppTransactionalLoggedInMutationUseCase[HomeSmallScreenTabRemoveArgs, None]
):
    """The command for archiving a home small screen tab."""
    ...
    async def _perform_transactional_mutation(
        ...
        args: HomeSmallScreenTabRemoveArgs,
    ) -> None:

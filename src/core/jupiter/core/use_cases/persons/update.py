...
class PersonUpdateUseCase(AppLoggedInMutationUseCase[PersonUpdateArgs, None]):
    ...
    async def _execute(
                ...
                if new_catch_up_period is not None:
                    ...
                    if args.catch_up_difficulty.should_change:
                        new_catch_up_difficulty = (
                            args.catch_up_difficulty.just_the_value
                        )
                    elif person.catch_up_params is not None:
                    ...
                    if args.catch_up_due_at_time.should_change:
                        new_catch_up_due_at_time = (
                            args.catch_up_due_at_time.just_the_value
                        )
                    elif person.catch_up_params is not None:
                    ...
                    if args.catch_up_due_at_day.should_change:
                        new_catch_up_due_at_day = (
                            args.catch_up_due_at_day.just_the_value
                        )
                    elif person.catch_up_params is not None:
        ...
        async with progress_reporter.start_updating_entity(
            ...
            async with self._storage_engine.get_unit_of_work() as uow:
                ...
                await entity_reporter.mark_known_name(str(person.name))

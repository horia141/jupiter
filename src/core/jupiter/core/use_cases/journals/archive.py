...
from jupiter.core.framework.use_case import ProgressReporter, UseCaseArgsBase, use_case_args
...
class JournalArchiveUseCase(AppTransactionalLoggedInMutationUseCase[JournalArchiveArgs, None]):
    """Use case for archiving a journal."""
    ...
    async def _perform_transactional_mutation(
        ...
        await generic_archiver(context.domain_context, uow, progress_reporter, Journal, args.ref_id)

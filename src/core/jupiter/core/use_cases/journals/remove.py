...
class JournalRemoveUseCase(AppTransactionalLoggedInMutationUseCase[JournalremoveArgs, None]):
    """Use case for removing a journal."""
    ...
    async def _perform_transactional_mutation(
        ...
        await generic_remover(context.domain_context, uow, progress_reporter, Journal, args.ref_id)

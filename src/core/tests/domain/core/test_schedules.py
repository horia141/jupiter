...
def test_contains_timestamp(right_now: Timestamp) -> None:
    ...
    assert not schedule.contains_timestamp(
        Timestamp.from_date_and_time(right_now.value.add(days=-3))
    )
    assert not schedule.contains_timestamp(
        Timestamp.from_date_and_time(right_now.value.add(days=-2))
    )
    assert schedule.contains_timestamp(
        Timestamp.from_date_and_time(right_now.value.add(days=-1))
    )
    assert schedule.contains_timestamp(
        Timestamp.from_date_and_time(right_now.value.add(days=0))
    )
    assert schedule.contains_timestamp(
        Timestamp.from_date_and_time(right_now.value.add(days=1))
    )
    ...
    assert schedule.contains_timestamp(
        Timestamp.from_date_and_time(right_now.value.add(days=4))
    )
    assert schedule.contains_timestamp(
        Timestamp.from_date_and_time(right_now.value.add(days=5))
    )
    assert not schedule.contains_timestamp(
        Timestamp.from_date_and_time(right_now.value.add(days=6))
    )
    assert not schedule.contains_timestamp(
        Timestamp.from_date_and_time(right_now.value.add(days=7))
    )

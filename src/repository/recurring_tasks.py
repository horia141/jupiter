...
class RecurringTasksRepository:
    ...
    def storage_to_live(storage_form: JSONDictType) -> RecurringTask:
        ...
        return RecurringTask(
            ...
            actionable_from_day=typing.cast(int, storage_form["actionable_from_day"]) if storage_form.get("actionable_from_day", None) else None,
            actionable_from_month=typing.cast(int, storage_form["actionable_from_month"]) if storage_form.get("actionable_from_month", None) else None,

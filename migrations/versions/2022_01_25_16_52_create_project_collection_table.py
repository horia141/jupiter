"""Create project collection table

Revision ID: f81984d09e7d
Revises: f0413820dee6
Create Date: 2022-01-25 16:52:06.669142
...
revision = 'f81984d09e7d'
down_revision = 'f0413820dee6'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.create_table(
        'project_collection_event',
        sa.Column('owner_ref_id', sa.Integer, sa.ForeignKey('project_collection.ref_id'), primary_key=True),
...
def downgrade() -> None:
    op.drop_table('project_collection_event')

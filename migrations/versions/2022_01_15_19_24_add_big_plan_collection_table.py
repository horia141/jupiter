"""Add big plan collection table

Revision ID: ebfe65b98854
Revises: 4df0e666abd6
Create Date: 2022-01-15 19:24:57.047921
...
revision = 'ebfe65b98854'
down_revision = '4df0e666abd6'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.create_table(
        'big_plan_collection_event',
        sa.Column('owner_ref_id', sa.Integer, sa.ForeignKey('big_plan_collection.ref_id'), primary_key=True),
...
def downgrade() -> None:
    ...
    op.drop_table('big_plan_collection')
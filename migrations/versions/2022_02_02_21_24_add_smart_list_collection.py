"""Add smart list collection

Revision ID: 6c71cc3b1c7d
Revises: 60da918ce56e
Create Date: 2022-02-02 21:24:56.815704
...
revision = '6c71cc3b1c7d'
down_revision = '60da918ce56e'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.create_table(
        'smart_list_collection_event',
        sa.Column('owner_ref_id', sa.Integer, sa.ForeignKey('smart_list_collection.ref_id'), primary_key=True),
...
def downgrade() -> None:
    ...
    op.drop_table('smart_list_collection')

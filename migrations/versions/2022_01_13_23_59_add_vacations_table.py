...
Revision ID: 5e59c55be9c5
Revises: c7d76ff55cea
Create Date: 2022-01-13 23:59:08.591574
...
revision = '5e59c55be9c5'
down_revision = 'c7d76ff55cea'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column('vacation_ref_id', sa.Integer, sa.ForeignKey('workspace.ref_id'), index=True,  nullable=False),
        sa.Column('name', sa.String(100), nullable=False),
        sa.Column('start_date', sa.DateTime, nullable=False),
        sa.Column('end_date', sa.DateTime, nullable=False))
    op.create_table(
        'vacation_event',
        sa.Column('owner_ref_id', sa.Integer, sa.ForeignKey('vacation.ref_id'), primary_key=True),

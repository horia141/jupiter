...
poetry run ruff check --cache-dir=.build-cache/ruff --config=./scripts/lint/ruff.toml src itests
...
poetry run bandit --configfile=./scripts/lint/bandit --ini=./scripts/lint/bandit.test.ini -r itests
poetry run pydocstyle --config=./scripts/lint/pydocstyle src/core src/cli src/webapi itests

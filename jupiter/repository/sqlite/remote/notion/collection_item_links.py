...
from jupiter.remote.notion.infra.collection_item_link_repository \
    import NotionCollectionItemLinkRepository, NotionCollectionItemLinkNotFoundError
...
class SqliteNotionCollectionItemLinkRepository(NotionCollectionItemLinkRepository):
    ...
    def save(self, notion_collection_item_link: NotionCollectionItemLink) -> NotionCollectionItemLink:
        ...
        result = self._connection.execute(
            ...
            .where(self._notion_collection_item_link_table.c.the_key == notion_collection_item_link.key)
            .values(
                notion_id=str(notion_collection_item_link.notion_id),
                last_modified_time=notion_collection_item_link.last_modified_time.to_db()))
    ...
    def load(self, key: NotionLockKey) -> NotionCollectionItemLink:
        ...
        query_stmt = \
            select(self._notion_collection_item_link_table)\
            .where(self._notion_collection_item_link_table.c.the_key == key)
    ...
    def find_all_for_collection(self, collection_key: NotionLockKey) -> Iterable[NotionCollectionItemLink]:
        ...
        query_stmt = \
            select(self._notion_collection_item_link_table)\
            .where(self._notion_collection_item_link_table.c.collection_key == collection_key)
    ...
    def remove(self, key: NotionLockKey) -> None:
        ...
        self._connection.execute(
            delete(self._notion_collection_item_link_table)
            .where(self._notion_collection_item_link_table.c.the_key == key))

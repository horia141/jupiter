...
from jupiter.remote.notion.infra.storage_engine import NotionUnitOfWork, NotionStorageEngine
...
from jupiter.repository.sqlite.remote.notion.collection_item_links import SqliteNotionCollectionItemLinkRepository
from jupiter.repository.sqlite.remote.notion.collection_links import SqliteNotionCollectionLinkRepository
from jupiter.repository.sqlite.remote.notion.page_links import SqliteNotionPageLinkRepository
...
class SqliteNotionUnitOfWork(NotionUnitOfWork):
    ...
    _notion_collection_field_tag_link_repository: Final[SqliteNotionCollectionFieldTagLinkRepository]
    _notion_collection_item_link_repository: Final[SqliteNotionCollectionItemLinkRepository]
    ...
    def __init__(
            ...
            notion_collection_item_link_repository: SqliteNotionCollectionItemLinkRepository) -> None:
        """Constructor."""
        ...
        self._notion_collection_field_tag_link_repository = notion_collection_field_tag_link_repository
        self._notion_collection_item_link_repository = notion_collection_item_link_repository
...
class SqliteNotionStorageEngine(NotionStorageEngine):
    ...
    def get_unit_of_work(self) -> typing.Iterator[NotionUnitOfWork]:
        ...
        with self._sql_engine.begin() as connection:
            notion_page_link_repository = SqliteNotionPageLinkRepository(connection, self._metadata)
            notion_collection_link_repository = SqliteNotionCollectionLinkRepository(connection, self._metadata)

...
class SqliteNotionCollectionFieldTagLinkRepository(
    NotionCollectionFieldTagLinkRepository
):
    """SQLite implementation of the Notion collection field tag link repository."""
    ...
    def save(
        ...
        result = self._connection.execute(
            ...
            .where(
                self._notion_collection_field_tag_link_table.c.the_key
                == notion_collection_field_tag_link.key
            )
            .values(
                notion_id=str(notion_collection_field_tag_link.notion_id),
                last_modified_time=notion_collection_field_tag_link.last_modified_time.to_db(),
    ...
    def load(self, key: NotionLockKey) -> NotionCollectionFieldTagLink:
        ...
        query_stmt = select(self._notion_collection_field_tag_link_table).where(
            self._notion_collection_field_tag_link_table.c.the_key == key
        )
    ...
    def find_all_for_collection(
        ...
        query_stmt = (
            ...
            .where(
                self._notion_collection_field_tag_link_table.c.collection_key
                == collection_key
            )
    ...
    def remove(self, key: NotionLockKey) -> None:
        ...
        self._connection.execute(
            delete(self._notion_collection_field_tag_link_table).where(
                self._notion_collection_field_tag_link_table.c.the_key == key
            )
        )

...
from jupiter.domain.inbox_tasks.infra.inbox_task_repository import (
    InboxTaskRepository,
...
class SqliteInboxTaskCollectionRepository(InboxTaskCollectionRepository):
    ...
    def __init__(self, connection: Connection, metadata: MetaData) -> None:
        ...
        self._inbox_task_collection_event_table = build_event_table(
            self._inbox_task_collection_table, metadata
        )
...
class SqliteInboxTaskRepository(InboxTaskRepository):
    ...
    def __init__(self, connection: Connection, metadata: MetaData) -> None:
        ...
        self._inbox_task_table = Table(
            ...
            Column(
                "big_plan_ref_id", Integer, ForeignKey("big_plan.ref_id"), nullable=True
            ),
            ...
            Column(
                "metric_ref_id", Integer, ForeignKey("metric.ref_id"), nullable=True
            ),
            Column(
                "person_ref_id", Integer, ForeignKey("person.ref_id"), nullable=True
            ),
            Column(
                "slack_task_ref_id",
                Integer,
        ...
        self._inbox_task_event_table = build_event_table(
            self._inbox_task_table, metadata
        )

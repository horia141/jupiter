...
from jupiter.domain.chores.infra.chore_repository import (
    ChoreRepository,
    ChoreNotFoundError,
)
...
class SqliteChoreCollectionRepository(ChoreCollectionRepository):
    ...
    def __init__(self, connection: Connection, metadata: MetaData) -> None:
        ...
        self._chore_collection_event_table = build_event_table(
            self._chore_collection_table, metadata
        )
        ...
        result = self._connection.execute(
            insert(self._chore_table).values(
                **ref_id_kw,
                ...
                if entity.gen_params and entity.gen_params.difficulty
                else None,
                gen_params_actionable_from_day=entity.gen_params.actionable_from_day.as_int()
                if entity.gen_params and entity.gen_params.actionable_from_day
                else None,
                gen_params_actionable_from_month=entity.gen_params.actionable_from_month.as_int()
                if entity.gen_params and entity.gen_params.actionable_from_month
                else None,
                gen_params_due_at_time=str(entity.gen_params.due_at_time)
                if entity.gen_params and entity.gen_params.due_at_time
                else None,
                gen_params_due_at_day=entity.gen_params.due_at_day.as_int()
                if entity.gen_params and entity.gen_params.due_at_day
                else None,
                gen_params_due_at_month=entity.gen_params.due_at_month.as_int()
                if entity.gen_params and entity.gen_params.due_at_month
                else None,

...
from jupiter.domain.push_integrations.slack.service.remove_service import SlackTaskRemoveService
...
class SlackTaskRemoveUseCase(AppMutationUseCase['SlackTaskRemoveUseCase.Args', None]):
    ...
    def _execute(self, context: AppUseCaseContext, args: Args) -> None:
        ...
        slack_task_remove_service = \
            SlackTaskRemoveService(
                self._storage_engine, self._inbox_task_notion_manager, self._slack_task_notion_manager)

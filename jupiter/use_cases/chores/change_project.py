...
class ChoreChangeProjectUseCase(AppMutationUseCase['ChoreChangeProjectUseCase.Args', None]):
    ...
    def _execute(self, context: AppUseCaseContext, args: Args) -> None:
        ...
        notion_chore = \
            self._chore_notion_manager.load_chore(
                chore.chore_collection_ref_id, chore.ref_id)
        notion_chore = \
            notion_chore.join_with_aggregate_root(chore, chore_direct_info)

...
class MetricChangeCollectionProjectUseCase(AppMutationUseCase['MetricChangeCollectionProjectUseCase.Args', None]):
    ...
    def _execute(self, context: AppUseCaseContext, args: Args) -> None:
        ...
        with self._storage_engine.get_unit_of_work() as uow:
            ...
            if args.collection_project_key is not None:
                project = uow.project_repository.load_by_key(project_collection.ref_id, args.collection_project_key)
                collection_project_ref_id = project.ref_id
            else:
                collection_project_ref_id = workspace.default_project_ref_id

            metric_collection =\
                metric_collection.change_collection_project(
                    collection_project_ref_id=collection_project_ref_id, source=EventSource.CLI,

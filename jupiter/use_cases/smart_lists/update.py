...
class SmartListUpdateUseCase(AppMutationUseCase['SmartListUpdateUseCase.Args', None]):
    ...
    def _execute(self, context: AppUseCaseContext, args: Args) -> None:
        ...
        notion_smart_list = self._smart_list_notion_manager.load_branch(smart_list_collection.ref_id, smart_list.ref_id)
        notion_smart_list = notion_smart_list.join_with_entity(smart_list)
        self._smart_list_notion_manager.save_branch(smart_list_collection.ref_id, notion_smart_list)

...
class NotionHabitsManager(HabitNotionManager):
    ...
    _DATABASE_BY_PROJECT_VIEW_SCHEMA: ClassVar[JSONDictType] = {
        ...
        "format": {
            ...
            "table_properties": [
                ...
                {"width": 100, "property": "repeats-in-period", "visible": True},
    ...
    _KANBAN_ALL_VIEW_SCHEMA: ClassVar[JSONDictType] = {
        ...
        "format": {
            ...
            "board_properties": [
                ...
                {"property": "repeats-in-period", "visible": False},
    ...
    def upsert_trunk(
        self, parent: NotionWorkspace, trunk: NotionHabitCollection
    ) -> None:
    ...
    def save_leaf(
        ...
        try:
            ...
            raise NotionHabitNotFoundError(
                f"Notion habit with id {leaf.ref_id} could not be found"
            ) from err
    ...
    def load_leaf(self, trunk_ref_id: EntityId, leaf_ref_id: EntityId) -> NotionHabit:
        ...
        try:
            ...
            raise NotionHabitNotFoundError(
                f"Notion habit with id {leaf_ref_id} could not be found"
            ) from err

    def load_all_leaves(self, trunk_ref_id: EntityId) -> Iterable[NotionHabit]:

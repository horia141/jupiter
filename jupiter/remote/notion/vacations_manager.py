...
class NotionVacationsManager(VacationNotionManager):
    ...
    _DATABASE_VIEW_SCHEMA: ClassVar[JSONDictType] = {
        ...
        "format": {
            "table_properties": [
                ...
                {"width": 200, "property": "start-date", "visible": True},
                {"width": 200, "property": "end-date", "visible": True},
    ...
    def upsert_trunk(
        self, parent: NotionWorkspace, trunk: NotionVacationCollection
    ) -> None:
    ...
    def save_leaf(
        ...
        try:
            ...
            raise NotionVacationNotFoundError(
                f"Vacation with id {leaf.ref_id} could not be found"
            ) from err
    ...
    def load_leaf(
        ...
        try:
            ...
            raise NotionVacationNotFoundError(
                f"Vacation with id {leaf_ref_id} could not be found"
            ) from err

...
class PushIntegrationGroup(TrunkEntity):
    ...
    def new_push_integration_group(
            workspace_ref_id: EntityId, source: EventSource, created_time: Timestamp) -> 'PushIntegrationGroup':
        ...
        push_integration_group = PushIntegrationGroup(
            ...
            events=[PushIntegrationGroup.Created.make_event_from_frame_args(source, FIRST_VERSION, created_time)],

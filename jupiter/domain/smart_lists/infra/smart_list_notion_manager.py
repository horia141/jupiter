...
class SmartListNotionManager(abc.ABC):
    ...
    def load_all_smart_list_tags(
            self, smart_list_collection_ref_id: EntityId, smart_list_ref_id: EntityId) -> Iterable[NotionSmartListTag]:
        """Retrieve all the Notion-side smart list tags."""

    @abc.abstractmethod
    def remove_smart_list_tag(
            self, smart_list_collection_ref_id: EntityId, smart_list_ref_id: EntityId,
            ref_id: Optional[EntityId]) -> None:
    ...
    def load_all_saved_smart_list_tags_notion_ids(
            self, smart_list_collection_ref_id: EntityId, smart_list_ref_id: EntityId) -> Iterable[NotionId]:
    ...
    def load_all_smart_list_items(
            self, smart_list_collection_ref_id: EntityId, smart_list_ref_id: EntityId) -> Iterable[NotionSmartListItem]:
    ...
    def load_all_saved_smart_list_items_ref_ids(
            self, smart_list_collection_ref_id: EntityId, smart_list_ref_id: EntityId) -> Iterable[EntityId]:

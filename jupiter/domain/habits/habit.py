...
class Habit(LeafEntity):
    ...
    def update(
        ...
        if gen_params.should_change:
            Habit._check_actionable_and_due_date_configs(
                gen_params.value.actionable_from_day,
                gen_params.value.actionable_from_month,
                gen_params.value.due_at_day,
                gen_params.value.due_at_month,
            )
        ...
        if (
            ...
            and repeats_in_period_count.value is not None
        ):

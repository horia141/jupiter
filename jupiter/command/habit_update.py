...
class HabitUpdate(command.Command):
    ...
    def __init__(
            self, global_properties: GlobalProperties, the_command: HabitUpdateUseCase) -> None:
        """Constructor."""
    ...
    def build_parser(self, parser: ArgumentParser) -> None:
        ...
        actionable_from_day.add_argument(
            ...
            const=True, help="Clear the actionable day of the habit")
        ...
        actionable_from_month.add_argument(
            ...
            const=True, help="Clear the actionable month of the habit")
        ...
        due_at_time.add_argument(
            ...
            const=True, help="Clear the due time of the habit")
        ...
        due_at_day.add_argument(
            ...
            const=True, help="Clear the due day of the habit")
        ...
        due_at_month.add_argument(
            ...
            const=True, help="Clear the due month of the habit")

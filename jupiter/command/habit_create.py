...
class HabitCreate(command.Command):
    ...
    def __init__(
            self, global_properties: GlobalProperties, the_command: HabitCreateUseCase) -> None:
        """Constructor."""
    ...
    def build_parser(self, parser: ArgumentParser) -> None:
        ...
        parser.add_argument("--name", dest="name", required=True, help="The name of the habit")
        parser.add_argument("--period", dest="period", choices=RecurringTaskPeriod.all_values(),
                            required=True, help="The period for the habit")

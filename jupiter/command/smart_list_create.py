...
class SmartListCreate(command.Command):
    ...
    def build_parser(self, parser: ArgumentParser) -> None:
        ...
        parser.add_argument("--icon", dest="icon", required=False, help="A unicode icon or :alias: for the smart list")
    ...
    def run(self, args: Namespace) -> None:
        ...
        self._command.execute(SmartListCreateUseCase.Args(key=smart_list_key, name=name, icon=icon))

"""Change the project for a recurring task."""
...
class RecurringTaskChangeProject(command.Command):
    """UseCase class for hard removing recurring tasks."""

    _command: Final[RecurringTaskChangeProjectUseCase]

    def __init__(self, the_command: RecurringTaskChangeProjectUseCase) -> None:
        """Constructor."""
    ...
    def description() -> str:
        ...
        return "Change the project for a recurring task"
    ...
    def build_parser(self, parser: ArgumentParser) -> None:
        ...
        project.add_argument(
            "--project", dest="project_key", help="The project key to reassign this recurring task to")
        project.add_argument(
    ...
    def run(self, args: Namespace) -> None:
        ...
        self._command.execute(RecurringTaskChangeProjectUseCase.Args(ref_id=ref_id, project_key=project_key))

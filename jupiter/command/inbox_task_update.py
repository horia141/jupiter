...
class InboxTaskUpdate(command.Command):
    ...
    def build_parser(self, parser: ArgumentParser) -> None:
        ...
        parser.add_argument("--id", type=str, dest="ref_id", required=True, help="The id of the inbox task to modify")
        parser.add_argument("--name", dest="name", required=False, help="The name of the inbox task")
        parser.add_argument(
        ...
        actionable_date.add_argument(
            "--actionable-date", dest="actionable_date", help="The actionable date of the inbox task")
        actionable_date.add_argument(

...
class ChoreChangeProject(command.Command):
    ...
    def build_parser(self, parser: ArgumentParser) -> None:
        ...
        project.add_argument(
            "--project", dest="project_key", help="The project key to reassign this chore to")
        project.add_argument(
    ...
    def run(self, args: Namespace) -> None:
        ...
        self._command.execute(ChoreChangeProjectUseCase.Args(ref_id=ref_id, project_key=project_key))

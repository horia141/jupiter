...
class SlackTaskChangeGenerationProject(Command):
    ...
    def build_parser(self, parser: ArgumentParser) -> None:
        ...
        generation_project_group.add_argument(
            "--generation-project", dest="generation_project_key", required=False,
            help="The project key to generate generation tasks")
        generation_project_group.add_argument(
            "--clear-generation-project", dest="clear_generation_project_key",
    ...
    def run(self, args: Namespace) -> None:
        ...
        self._command.execute(
            SlackTaskChangeGenerationProjectUseCase.Args(generation_project_key=generation_project_key))

...
class ChoreShow(command.Command):
    ...
    def __init__(
            self, global_properties: GlobalProperties, the_command: ChoreFindUseCase) -> None:
        """Constructor."""
    ...
    def run(self, args: Namespace) -> None:
        ...
        response = self._command.execute(ChoreFindUseCase.Args(
        ...
        for chore_entry in response.chores:
            ...
            difficulty_str = \
                chore.gen_params.difficulty.value if chore.gen_params.difficulty else "none"
            print(f'id={chore.ref_id} {chore.name}' +
                  ...
                  (f' start_at_date={chore.start_at_date}' if chore.start_at_date else '') +

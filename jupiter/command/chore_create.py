...
class ChoreCreate(command.Command):
    ...
    def __init__(
            self, global_properties: GlobalProperties, the_command: ChoreCreateUseCase) -> None:
        """Constructor."""
    ...
    def build_parser(self, parser: ArgumentParser) -> None:
        ...
        parser.add_argument("--name", dest="name", required=True, help="The name of the chore")
        parser.add_argument("--period", dest="period", choices=RecurringTaskPeriod.all_values(),
                            required=True, help="The period for the chore")
    ...
    def run(self, args: Namespace) -> None:
        ...
        self._command.execute(ChoreCreateUseCase.Args(

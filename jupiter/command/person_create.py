...
class PersonCreate(command.Command):
    ...
    def build_parser(self, parser: ArgumentParser) -> None:
        ...
        parser.add_argument(
            "--relationship", dest="relationship", required=True,
        ...
        parser.add_argument(
            "--catch-up-difficuslty", dest="catch_up_difficulty", choices=Difficulty.all_values(),
        ...
        parser.add_argument(
            "--catch-up-due-at-day", type=int, dest="catch_up_due_at_day", metavar="DAY",
            help="The day of the interval the catch up task will be due on")
        parser.add_argument(
            "--catch-up-due-at-month", type=int, dest="catch_up_due_at_month", metavar="MONTH",
    ...
    def run(self, args: Namespace) -> None:
        ...
        catch_up_eisen = Eisen.from_raw(args.catch_up_eisen) if args.catch_up_eisen else None

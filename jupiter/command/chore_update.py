...
class ChoreUpdate(command.Command):
    ...
    def __init__(
            self, global_properties: GlobalProperties, the_command: ChoreUpdateUseCase) -> None:
        """Constructor."""
    ...
    def build_parser(self, parser: ArgumentParser) -> None:
        ...
        actionable_from_day.add_argument(
            ...
            const=True, help="Clear the actionable day of the chore")
        ...
        actionable_from_month.add_argument(
            ...
            const=True, help="Clear the actionable month of the chore")
        ...
        due_at_time.add_argument(
            ...
            const=True, help="Clear the due time of the chore")
        ...
        due_at_day.add_argument(
            ...
            const=True, help="Clear the due day of the chore")
        ...
        due_at_month.add_argument(
            ...
            const=True, help="Clear the due month of the chore")
        parser.add_argument(
        ...
        end_at_date.add_argument(
            ...
            const=True, help="Clear the end date of the chore")
        ...
        skip_rule.add_argument(
            ...
            const=True, help="Clear the skip rule of the chore")
    ...
    def run(self, args: Namespace) -> None:
        ...
        self._command.execute(ChoreUpdateUseCase.Args(
            ref_id=ref_id,
            name=name,
            period=period,
            eisen=eisen,
